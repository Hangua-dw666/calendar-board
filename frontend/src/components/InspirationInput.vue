<template>
  <div class="terminal-card p-4">
    ...
    <div class="space-y-3">
      <input v-model="form.title" type="text" placeholder="灵感标题..." class="terminal-input w-full" />
      ...
      <button @click="handleSave" :disabled="saving" class="terminal-btn w-full disabled:opacity-50" style="background-color: #ffd700;">
        {{ saving ? '保存中...' : '保存灵感' }}
      </button>
    </div>
  </div>
